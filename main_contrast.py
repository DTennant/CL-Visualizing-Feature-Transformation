...
from dataset.util import build_contrast_loader
from dataset.util import build_linear_loader
...
def main():
    ...
    if args.multiprocessing_distributed:
        ...
        mp.spawn(main_func, nprocs=ngpus_per_node, args=(ngpus_per_node, args))
    else:
