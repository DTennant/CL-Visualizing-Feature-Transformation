...
class BaseOptions(object):
    ...
    def __init__(self):
        ...
        self.override_dict = {
            ...
            'MoCoMLP':    ['RGB', False, 'moco', 'A', 'mlp', 0.07],
            'MoCo_wo_norm':    ['RGB', False, 'moco', 'A', 'linear_wo_norm', 0.07],
            'PIRL':    ['RGB', True,  'bank', 'A', 'linear', 0.07],
            'MoCov2':  ['RGB', False, 'moco', 'B', 'mlp',    0.2],
            'MoCov2_tau0.1':  ['RGB', False, 'moco', 'B', 'mlp',    0.1],
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--imagenet100path', type=str, default='/export/home/zhur5/project/pycontrast/imagenet100.class')
        ...
        parser.add_argument('--method', default='Customize', type=str,
                            choices=['InsDis', 'CMC', 'CMCv2', 'MoCo', 'MoCoMLP',
                             'MoCo_wo_norm', 'MoCov2', 'MoCov2_tau0.1',
        ...
        parser.add_argument('--mem', default='moco', type=str, choices=['bank', 'moco'],
        ...
        parser.add_argument('--head', default='linear', type=str,
                            choices=['linear', 'linear_wo_norm', 'mlp', 'mlp_bn', '2mlp_bn'], help='projection head')
